        ...
        <Card className="smooth-shadow-md">
          ...
          <Card.Body className="p-6">
            <div className="mb-4">
              ...
              <p className="mb-6">Điền thông tin.</p>
            </div>
            {/* Form */}
            {hasMounted && 
            <Form>
              ...
              <div className="mb-3">
                <Form.Check type="checkbox" id="check-api-checkbox">
                  ...
                  <Form.Check.Label>
                    Tôi đồng  ý <Link href="#"> Với chính  sách dịch vụ </Link> and <Link href="#"> bảo mật.</Link>
                  </Form.Check.Label>
                </Form.Check>
              </div>
              ...
              <div>
                ...
                <div className="d-md-flex justify-content-between mt-4">
                  <div className="mb-2 mb-md-0">
                    <Link href="/authentication/sign-in" className="fs-5"> Đăng nhập </Link>
                  </div>
                  <div>
                    <Link href="/authentication/forget-password" className="text-inherit fs-5">Quên mật khẩu?</Link>
                  </div>
                </div>
              </div>
            </Form>
