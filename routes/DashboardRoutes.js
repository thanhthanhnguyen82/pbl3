...
export const DashboardMenu = [
	...
	},
	{
		...
		icon: 'layers',
		children: [
			{ id: uuid(), link: '/pages/profile', name: 'Hồ sơ' },
			{ id: uuid(), link: '/pages/settings', name: 'cài đặt'},
			
			{ id: uuid(), link: '/pages/pricing', name: 'Tiến độ'},
	...
	},	
	{
		...
		children: [
			...
			{ id: uuid(), link: '/authentication/sign-up', name: 'Đăng xuất' },
			{ id: uuid(), link: '/authentication/forget-password', name: 'Quên mật khẩu'}			
		]
	},
	...
	},	
	{
		...
		children: [
			...
			{ id: uuid(), link: '/components/alerts', name: 'Cảnh báo' },
			{ id: uuid(), link: '/components/badges', name: 'danh hiệu' },
			{ id: uuid(), link: '/components/breadcrumbs', name: 'Breadcrumbs' },
			{ id: uuid(), link: '/components/buttons', name: 'Nút' },
			{ id: uuid(), link: '/components/button-group', name: 'Nhóm nút' },
	...
	},	
	{
		...
		children: [
			{ 
				...
				title: 'Mức 2',
				children: [
					{ id: uuid(), link: '#', name: 'Mục điều hướng 1'},
					{ id: uuid(), link: '#', name: 'Mục điều hướng 2' }
				]
			},
			{ 
				id: uuid(), 
				...
				children: [
					{ 
						...
						title: 'NavItem 1',
						children: [
							{ id: uuid(), link: '#', name: 'Điều hướng mức con 1'},
							{ id: uuid(), link: '#', name: 'Điều hướng mức con 2'}
						]
					},
					{ id: uuid(), link: '#', name: 'Điều hướng mức 2' }
				]
			}
		]
	},	
